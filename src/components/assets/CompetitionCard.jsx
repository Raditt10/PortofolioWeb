...
function CompetitionCard() {
  return (
    <section className='flex flex-col items-center justify-around max-w-[390px] min-h-[380px] bg-gradient-to-r from-[#280087] to-[#C00000] rounded-2xl p-1 text-center gap-5'>
            ...
            <p className='text-white text-center text-sm'>"I'am proudly secured 1st place in the ISSC Event, This marks our first-ever achievement in a competition, making it a truly memorable milestone."</p>
